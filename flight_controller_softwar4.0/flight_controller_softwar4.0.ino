...
myFile.println(" ");
myFile.println(" ");
myFile.println("Motor burnout detected - Coasting");
flightState = 4;
...
if (maxAlt-1 > totalAlt){
myFile.println(" ");
myFile.println(" ");
myFile.println(" ");
myFile.println("Apogee detected - Waiting for decent");
flightState = 5;
...
if (maxAlt-2           > totalAlt){
myFile.println(" ");
myFile.println(" ");
myFile.println(" ");
myFile.println("Freefall Detected - deploying parachute in 5 meters");
flightState = 6;
...
if (maxAlt - totalAlt > 5){
myFile.println(" ");
myFile.println(" ");
myFile.println(" ");
myFile.println("Freefall comfirmed - deploying parachute");
...
if(zaccelfinal>8 or xaccelfinal>8 or yaccelfinal>8){

myFile.println(" ");
myFile.println(" ");
myFile.println(" ");
myFile.println("Chute Deploy detected");
flightState = 7 ;
