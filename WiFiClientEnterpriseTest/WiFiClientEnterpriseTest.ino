...
#define EAP_IDENTITY "mshep23" //if connecting from another corporation, use identity@organisation.domain in Eduroam 
#define EAP_USERNAME "mshep23" //oftentimes just a repeat of the identity
#define EAP_PASSWORD "Correct battery horse7@" //your Eduroam password
const char* ssid = "Somerset College"; // Eduroam SSID
